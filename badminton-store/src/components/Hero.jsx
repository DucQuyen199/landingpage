...
export default function Hero() {
  ...
  return (
    <>
      ...
      <section className="w-screen relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] mt-20">
        <motion.div
        ...
        >
          ...
          <div className="absolute inset-0 flex items-center justify-start p-12">
            <div className="max-w-xl">
              ...
              >
                <p className="text-orange-500 font-bold text-lg mb-2">Vợt cầu lông chính hãng</p>
                <h1 className="text-5xl font-bold text-white mb-4 leading-tight">
                  Nâng cấp game của bạn<br />với vợt chuyên nghiệp
                </h1>
                <p className="text-lg text-gray-200 mb-6">
                  Giảm giá đến 50% cho sản phẩm chính hãng
                </p>
                <button className="px-8 py-3 bg-orange-600 text-white font-bold rounded-lg hover:bg-orange-700 transition-all duration-300 flex items-center gap-2 inline-flex">
                  Mua ngay
                  <ArrowRight size={20} />
                </button>
              </motion.div>
      ...
      <section className="px-4 sm:px-6 lg:px-8 bg-white py-12">
        <div className="max-w-7xl mx-auto">
          {/* Category Grid */}
          <div className="mb-8">
            <h2 className="text-2xl font-bold text-slate-900 mb-6">Danh mục sản phẩm</h2>
            <motion.div
            ...
            >
              {categories.map((category, index) => (
                ...
                >
                  <div className="relative rounded-xl overflow-hidden bg-gray-100 aspect-square mb-3 hover:shadow-lg transition-all duration-300">
                    <img
                      src={category.image}
                      alt={category.name}
                  ...
                  <p className="text-sm font-semibold text-center text-slate-800 group-hover:text-orange-600 transition-colors">
                    {category.name}
                  </p>
                </motion.div>
              ))}
          ...
          <motion.div
            ...
            className="bg-gradient-to-r from-orange-500 to-orange-600 rounded-2xl p-8 text-white flex items-center justify-between"
          >
            <div>
              <p className="text-sm font-bold uppercase tracking-wider mb-2">⚡ Flash Sale</p>
              <h3 className="text-3xl font-bold mb-2">Giảm giá lên đến 50%</h3>
              <p className="text-orange-100">Hôm nay chỉ - Kết thúc lúc 23:59</p>
            </div>
            <button className="px-8 py-3 bg-white text-orange-600 font-bold rounded-lg hover:bg-gray-100 transition-all duration-300 whitespace-nowrap">
              Xem ngay
            </button>
          </motion.div>
        </div>
